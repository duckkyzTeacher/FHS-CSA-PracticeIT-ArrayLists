...
public class PracticeITArrayList {
    ...
    /**
     * 10.2 Write a method swapPairs that switches the order of values in an ArrayList of Strings in a pairwise fashion.
    ...
    /**
     * 10.3 Write a method removeEvenLength that takes an ArrayList of Strings as a parameter and that removes
     * all of the strings of even length from the list.
     */


    /**
     * 10.4 Write a method doubleList that takes an ArrayList of Strings as a parameter and that replaces
     * every string with two of that string.
     */


    /**
     * 10.6 Write a method minToFront that takes an ArrayList of integers as a parameter and that moves the 
     * minimum value in the list to the front, otherwise preserving the order of the elements.
     */


    /**
     * 10.7 Write a method removeDuplicates that takes as a parameter a sorted ArrayList of Strings and that
     * eliminates any duplicates from the list.
     */


    /**
     * 10.10 Write a method called removeInRange that accepts four parameters: 
    ...
    /**
     * 10.11 Write a method stutter that takes an ArrayList of Strings and an integer k as parameters
	...
	/**
	 * 10.14 Write a method removeShorterStrings that takes an ArrayList of Strings as a parameter 
    ...
    /**
	 * 10.17 Write a method called interleave that accepts two ArrayLists of integers a1 and a2 as parameters and 
